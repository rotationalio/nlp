...
This package provides a struct for computing online descriptive statistics without saving all values in an array or to disk.

Original repository: <https://github.com/bbengfort/x/stats>
